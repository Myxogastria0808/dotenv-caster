...
describe("Test of DotEnvCaster Class", () => {
  ...
  test.concurrent("castNumber: string | undefined -> Error (input string type)", () => {
    ...
    expect(() => dotenvCaster.castNumber(stringSample)).toThrowError(
      "This constant can not convert to number.",
    );
  });
  // input string type that can be converted to boolean type
  test.concurrent("castNumber: string | undefined -> Error (input string type that can be converted to boolean type)", () => {
    const booleanSample: string = "true";
    expect(() => dotenvCaster.castNumber(booleanSample)).toThrowError(
      "This constant can not convert to number.",
    );
  });
  ...
  test.concurrent("castNumber: string | undefined -> Error (input string type that can be converted to null)", () => {
    ...
    expect(() => dotenvCaster.castNumber(nullSample)).toThrowError(
      "This constant can not convert to number.",
    );
  });
  //* castBigInt *//
  ...
  test.concurrent("castBigInt: string | undefined -> Error (input string type)", () => {
    const stringSample: string = "Hello, World!";
    expect(() => dotenvCaster.castBigInt(stringSample)).toThrowError(
      "This constant can not convert to bigint.",
    );
  });
  // input string type that can be converted to boolean type
  test.concurrent("castBigInt: string | undefined -> Error (input string type that can be converted to boolean type)", () => {
    const booleanSample: string = "true";
    expect(() => dotenvCaster.castBigInt(booleanSample)).toThrowError(
      "This constant can not convert to bigint.",
    );
  });
  // input string type that can be converted to null
  test.concurrent("castBigInt: string | undefined -> Error (input string type that can be converted to null)", () => {
    const nullSample: string = "null";
    expect(() => dotenvCaster.castBigInt(nullSample)).toThrowError(
      "This constant can not convert to bigint.",
    );
  });
  //* castSymbol *//
  ...
  test.concurrent("castBoolean: string | undefined -> Error (input string type)", () => {
    const stringSample: string = "Hello, World!";
    expect(() => dotenvCaster.castBoolean(stringSample)).toThrowError(
      "This constant can not convert to boolean.",
    );
  });
  // input string type that can be converted to number type
  test.concurrent("castBoolean: string | undefined -> Error (input string type that can be converted to number type)", () => {
    const numberSample: string = "0";
    expect(() => dotenvCaster.castBoolean(numberSample)).toThrowError(
      "This constant can not convert to boolean.",
    );
  });
  // input string type that can be converted to null
  test.concurrent("castBoolean: string | undefined -> Error (input string type that can be converted to null)", () => {
    const nullSample: string = "null";
    expect(() => dotenvCaster.castBoolean(nullSample)).toThrowError(
      "This constant can not convert to boolean.",
    );
  });
  //* castNull *//
  ...
  test.concurrent("castNull: string | undefined -> Error (input string type)", () => {
    const stringSample: string = "Hello, World!";
    expect(() => dotenvCaster.castNull(stringSample)).toThrowError(
      "This constant can not convert to null.",
    );
  });
  // input string type that can be converted to number type
  test.concurrent("castNull: string | undefined -> Error (input string type that can be converted to number type)", () => {
    const numberSample: string = "0";
    expect(() => dotenvCaster.castNull(numberSample)).toThrowError(
      "This constant can not convert to null.",
    );
  });
  // input string type that can be converted to boolean type
  test.concurrent("castNull: string | undefined -> Error (input string type that can be converted to boolean type)", () => {
    const booleanSample: string = "true";
    expect(() => dotenvCaster.castNull(booleanSample)).toThrowError(
      "This constant can not convert to null.",
    );
  });
});
